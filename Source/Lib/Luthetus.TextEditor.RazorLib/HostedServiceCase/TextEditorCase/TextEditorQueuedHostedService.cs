...
public class TextEditorQueuedHostedService : BackgroundService
{
    ...
    public TextEditorQueuedHostedService(
        ITextEditorBackgroundTaskQueue taskQueue,
        ITextEditorBackgroundTaskMonitor taskMonitor,
        ...
        ILoggerFactory loggerFactory)
    {
        ...
        _logger = loggerFactory.CreateLogger<TextEditorQueuedHostedService>();
    }
